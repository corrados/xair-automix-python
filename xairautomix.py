...
channel_dict = { \
   ...
   1:["E-Git Mono", -90,   5, 101, [],                                                       guitar], \
   2:["Stefan",       0,  23, 121, [],                                                       vocal], \
   3:["Miguel",      -2,  32, 121, [[4, 124.7, 1], [-3.5, 2340, 2]],                         vocal], \
   4:["Chris",       -2,  25, 121, [[1.25, 1260, 2], [1.75, 3680, 2]],                       vocal], \
   5:["E-Bass",      -2,   0,  25, [],                                                       bass], \
   6:["E-Git L",     -2,   5, 101, [],                                                       guitar], \
   7:["E-Git R",     -2,   5, 101, [],                                                       guitar, ["LINK"]], \
   8:["Akustik",     -5,   6, 101, [],                                                       guitar], \
   9:["Kick",        -2, -13,  25, [[3, 58.3, 2], [-3.75, 158.9, 1.4], [5.75, 3090, 2]],     drums, ["PHANT"]], \
  10:["Snare",       -2,  10, 101, [[-3, 232.3, 3.1], [-2.5, 990.9, 3.5], [3, 7090, 2]],     drums], \
  11:["Tom1",        -2,   6,  40, [[3, 133.7, 1.8], [-6.25, 701.5, 1.1], [4.5, 3200, 1.7]], drums], \
  12:["Tom2",        -2,   2,  25, [[4, 85.3, 2], [-6.75, 550.8, 0.7], [4.25, 3430, 2]],     drums], \
  13:["OverH",       -5,   8, 101, [[0, 1490]],                                              drums, ["PHANT"]], \
...
busses_dict = { \
  0:["Stefan Mon",   [-90,   0, -90,   0,   0,   0, -90, -90, -90, -10, -15, -15, -15, -10, -10, -10], -10          ], \
  1:["Chris Mon",    [-90, -90,   0,   0, -90, -10, -90, -90,  -3,  -6,  -9,  -9,  -9,  -6,  -6,  -6], -10          ], \
  ...
  4:["Volker Mon L", [  0, -90, -10, -10, -10, -12, -12, -12, -18,   0,   0,   0,   0,   0,   0,   0], -10          ], \
  5:["Volker Mon R", [  0, -90, -10, -10, -10, -12, -12, -12, -18,   0,   0,   0,   0,   0,   0,   0], -10, ["LINK"]], \
